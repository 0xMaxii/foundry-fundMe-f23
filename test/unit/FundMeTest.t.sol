...
contract FundMeTest is Test {
    ...
    function setUp() external {
        ...
        (fundMe, ) = deployFundMe.run(); // Access the fundMe property from the tuple
     ...
     * 4. Staging
     *    - Testing opur code in a real environment that is not prod.
     */
    ...
    function testWithdrawWithSingleFunder() public funded {
        // Methodologies for working with tests
        // Arrange
    ...
    function testWithdrawFromMultipleFundersCheaper() public funded {
        ...
        for (uint160 i = startingFundersIndex; i < numberOfFunders; i++) {
            ...
            // vm.deal (we're gonna deal that new address some money)
            // address()
